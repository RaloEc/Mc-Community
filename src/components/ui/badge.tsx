  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive: "border-transparent bg-red-600 text-white shadow hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700",
        success: "border-transparent bg-green-600 text-white shadow hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700",
