        ...
        <Table>
          ...
          <TableBody>
            ...
            {(() => {
              ...
              const principales = ordenadas.filter(cat => !cat.parent_id);
              const subcategorias = ordenadas.filter(cat => cat.parent_id);
              ...
              const renderCategoria = (cat: CategoriaNoticia, esSubcategoria = false) => (
                <TableRow 
                  ...
                  <TableCell>
                    {cat.categoria_padre && cat.categoria_padre.nombre ? (
                      <span>{cat.categoria_padre.nombre}</span>
                    ) : (
              ...
              for (const principal of principales) {
                ...
                const hijos = subcategorias.filter(sub => sub.parent_id === principal.id);
              ...
              const huerfanas = subcategorias.filter(sub => 
                !principales.some(p => p.id === sub.parent_id)
              );
