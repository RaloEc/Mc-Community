...
import { FollowersResponse } from '@/types/social'

// GET /api/social/[publicId]/followers?page=1&limit=20
export async function GET(
  ...
  try {
    ...
    // Obtener seguidores con información de perfil
    ...
    if (followersError) {
      console.error('[Followers GET] Error:', followersError)
