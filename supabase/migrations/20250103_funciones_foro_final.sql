-- =====================================================
-- FUNCIONES FORO - VERSIÓN FINAL CORREGIDA
-- Tipos de datos ajustados a la estructura real de las tablas
-- =====================================================
...
-- Verificación
SELECT 'Funciones creadas correctamente' as mensaje;
...
SELECT COUNT(*) as total FROM get_hilos_populares(5, 30);

SELECT 'Probando get_estadisticas_por_categoria...' as test;
SELECT COUNT(*) as total FROM get_estadisticas_por_categoria();

SELECT 'Probando get_hilos_recientes_moderacion...' as test;
SELECT COUNT(*) as total FROM get_hilos_recientes_moderacion(5, 0, NULL, 'created_at', 'DESC');

SELECT 'Probando get_comentarios_recientes_moderacion...' as test;
SELECT COUNT(*) as total FROM get_comentarios_recientes_moderacion(5, 0);
